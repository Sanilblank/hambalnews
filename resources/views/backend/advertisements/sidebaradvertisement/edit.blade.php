...
<div class="content-wrapper">
    <div class="container-fluid">
        <a href="{{route('sidebarindex')}}" class="btn btn-danger mt-3">Back</a>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('updatesidebar', $sidebar_advertisement->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")

                            <div class="form-group">
                                <label for="Link">Link / URL (URL to the advertisement website/ FB page, stc.)</label>
                                <input type="text" name="link" class="form-control {{($errors->any() && $errors->first('link')) ? 'is-invalid' : ''}}" value="{{$sidebar_advertisement->link}}">
                                @if($errors->any())
                            ...
                            <div class="form-group">
                                <input type="checkbox" name="status" value="1"{{$sidebar_advertisement->status == 1? "checked" : ""}}>
